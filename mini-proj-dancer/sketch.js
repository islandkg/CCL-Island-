...
class Dancer{
    ...
    this.y = height/2;
    this.scaleFactor = 1;
    this.kick = random(-1,0.89);
    this.eyecolor = random(0,255);
    this.eyecolorchangeR = random(-150,150);
    this.eyecolorchangeG = random(-150,150);
    this.eyecolorchangeB = random(-150,150);
    this.earAngle = 0.25;
  ...
  feet_move(){
    ...
    this.feetsize = map(feetsinValue, -1, 1, this.kick, this.kick+0.8);
  }
  
  ears_move(){
    earangleSpeed = mouseX*0.01+1;
    let earsinValue = sin(frameCount * 0.07*earangleSpeed); 
    this.earAngle = map(earsinValue, -1, 1, -0.25, 0.25);
  ...
  body_jump(){
    ...
    display(){
     ...
     push();
      ...
      //belly
      ellipse(0,5,80,160);
      fill(100+this.eyecolorchangeR*0.2,100+this.eyecolorchangeG*0.2,100+this.eyecolorchangeB*0.2);
      ellipse(0,30,70,110);
        ...
        fill("white");
        circle(0-20,-95,20);
        fill(this.eyecolor+this.eyecolorchangeR,this.eyecolor+this.eyecolorchangeG,this.eyecolor+this.eyecolorchangeB);
        circle(0-20,-95,10);
        fill("white");
        circle(0+20,-95,20);
        fill('black');
      ...
      fill(220,130,120);
      translate(-60,-120);
      rotate(this.earAngle);
     //see the translation 
      fill(220);
      //circle(0,0,3);
      fill(100+this.eyecolorchangeR*0.5,100+this.eyecolorchangeG*0.6,100+this.eyecolorchangeB*0.2,200);
